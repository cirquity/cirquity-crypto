...
describe('Cryptography', () => {
  describe('Core', () => {
    ...
    it('Generate Ring Signatures', () => {
      ...
      const publicKeys = new TurtleCoinCrypto.VectorString()
      publicKeys.push_back('492390897da1cabd3886e3eff43ad1d04aa510a905bec0acd31a0a2f260e7862')
      publicKeys.push_back('7644ccb5410cca2be18b033e5f7497aeeeafd1d8f317f29cba4803e4306aa402')
      publicKeys.push_back('bb9a956ffdf8159ad69474e6b0811316c44a17a540d5e39a44642d4d933a6460')
      publicKeys.push_back('e1cd9ccdfdf2b3a45ac2cfd1e29185d22c185742849f52368c3cdd1c0ce499c0')
    ...
    it('Prepare Ring Signatures: Precomputed k', () => {
      ...
      const prep = TurtleCoinCrypto.prepareRingSignaturesK(prefixHash, keyImage, publicKeys, 3, k)

      const signatures = TurtleCoinCrypto.completeRingSignatures(privateEphemeral, 3, k, prep.signatures)
    ...
    describe('N/N', () => {
      ...
      describe('Party 2', () => {
        ...
        it('Restore Ring Signatures from Partial Signing Keys', () => {
          ...
          for (var i = 0; i < prep.signatures.size(); i++) {
            tempSignatures.push(prep.signatures.get(i))
          }

          const sig1 = TurtleCoinCrypto.generatePartialSigningKey(tempSignatures[3], party1.spend.secretKey)

          const sig2 = TurtleCoinCrypto.generatePartialSigningKey(tempSignatures[3], party2.spend.secretKey)

          const partialSigs = new TurtleCoinCrypto.VectorString()
          partialSigs.push_back(sig1)
          partialSigs.push_back(sig2)

          const sigs = TurtleCoinCrypto.restoreRingSignatures(tx.derivation, tx.input.index, partialSigs, 3, prep.key, prep.signatures)
